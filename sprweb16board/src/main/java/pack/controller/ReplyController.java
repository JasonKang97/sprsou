...
public class ReplyController {
	...
	@GetMapping("reply")
	public String reply(Model model, @RequestParam("num")int num, @RequestParam("page")String page) {
	...
	@PostMapping("reply")
	public String replyProcess(BoardBean bean, Model model, @RequestParam("page")int page) {
		// onum 갱신
